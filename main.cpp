...
void My_Init()
{
	...
	//skybox
	state_link = glGetUniformLocation(program_window, "state");
	eyepos_link = glGetUniformLocation(program_window, "eyepos");
	...
	glUniform4fv(glGetUniformLocation(program_window, "materAmbient"), 1, materAmbient);
	glUniform4fv(glGetUniformLocation(program_window, "materSpecular"), 1, materSpecular);
	glUniform4fv(glGetUniformLocation(program_window, "lightDiffuse"), 1, lightDiffuse);
	glUniform4fv(glGetUniformLocation(program_window, "lightAmbient"), 1, lightAmbient);
	glUniform4fv(glGetUniformLocation(program_window, "lightSpecular"), 1, lightSpecular);
	glUniform4fv(glGetUniformLocation(program_window, "envirAmbient"), 1, envirAmbient);

	names.attributes.position = glGetAttribLocation(program_window, "position");
	glGenBuffers(1, &names.vertex_buffer);

	names.attributes.normal = glGetAttribLocation(program_window, "normal");
	...
	glUniformMatrix4fv(glGetUniformLocation(program_window, "modelViewMat"), 1, GL_FALSE, glm::value_ptr(ModelViewMat));
	glUniformMatrix4fv(glGetUniformLocation(program_window, "perspProjMat"), 1, GL_FALSE, glm::value_ptr(Projection));
	glUniformMatrix3fv(glGetUniformLocation(program_window, "normalMat"), 1, GL_FALSE, glm::value_ptr(NormalMat));
...
void My_Display()
{
	...
	//glUniformMatrix4fv(um4mv, 1, GL_FALSE, value_ptr(lightView));
	...
	glUniform3fv(eyepos_link, 1, value_ptr(cameraPos));
	...
	glUniform1f(glGetUniformLocation(program_window, "time"), values.time);
